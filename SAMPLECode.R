...
PM25findat_SAMPLE<-read.csv("/Users/honghyokkim/YSE Dropbox/Honghyok Kim/UIC/Manuscript/June2023WF/Rcode_For_GitHub/SAMPLEdata.csv")
### Propensity Score Stratification Information
load(file="/Users/honghyokkim/Dropbox (YSE)/UIC/Manuscript/June2023WF/PSBalancing/MS_INFO_PS_new.RData")
